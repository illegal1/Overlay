document.addEventListener('DOMContentLoaded', () => {
    ...
    function updateCard(data) {
        ...
        const player = data.radiant.players.concat(data.dire.players).find(player => player.selected_unit);
    ...
    function updateXPBox(data) {
        const radiantXP = data.radiant.players.reduce((total, player) => total + player.experience, 0);
        const direXP = data.dire.players.reduce((total, player) => total + player.experience, 0);
