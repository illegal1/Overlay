...
const createPlayerRow = (player) => {
    ...
    row.innerHTML = `
	<td><img src="${getHeroImageUrl(player.hero_name)}" class="img-fluid rounded-start" alt="${getHeroName(player.hero_name)}" style="width: 150px;"></td>
...
const createPlayerCard = (player) => {
                        ...
                        <p class="card-text">
                            <div class="row">
                                ${player.top_heroes.map((hero, index) => `
                                    <div class="col-md-2">
                                        <img src="${getHeroImageUrl(hero.name)}" width="80" height="auto" class="img-fluid rounded-start" alt="${hero.name}">
    ...
    return `
        <div class="card text-white bg-dark mb-3">
            <div class="row g-0">
                <div class="col-md-3">
                    <img src="${getHeroImageUrl(player.hero_name)}" class="img-fluid rounded-start" alt="${getHeroName(player.hero_name)}">
                </div>
                <div class="col-md-9">
                    <div class="card-body">
                        <h5 class="card-title">${player.name || 'Unknown'} &nbsp; &nbsp; &nbsp; <span class="circle">${player.level || 0}</span></h5>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <p class="card-text">
                                    ...
                                    K/D/A: <strong>${player.kills || 0}/${player.deaths || 0}/${player.assists || 0}</strong>
                                </p>
                            </div>
                            <div class="col-md-6">
                                <p class="card-text">
                                    Average Kill/Death: <strong>${player.avgkill_20.toFixed(2) || 0}/${player.avg_death.toFixed(2) || 0}</strong>
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <p class="card-text">
                                    ...
                                    Net Worth: <strong>${player.net_worth || 0}</strong>
                                </p>
                            </div>
                            <div class="col-md-6">
                                <p class="card-text">
                                    Gold Lost To Death: <strong>${player.gold_lost_death || 0}</strong>
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <p class="card-text">
                                    ...
                                    Hero Damage: <strong>${player.hero_damage || 0}</strong>
                                </p>
                            </div>
                            <div class="col-md-6">
                                <p class="card-text">
                                    ...
                                    Tower Damage: <strong>${player.tower_damage || 0}</strong>
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <p class="card-text">
                                    ...
                                    Wards Placed: <strong>${player.wards_placed || 0}</strong>
                                </p>
                            </div>
                            <div class="col-md-6">
                                <p class="card-text">
                                    <svg fill="grey" height="20px" width="20px" version="1.2" baseProfile="tiny" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 256 256" xml:space="preserve" stroke="grey"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path id="XMLID_28_" d="M244.7,101.5C218.1,66,175.8,42.9,128,42.9S37.9,66,11.3,101.5c-4.9,6.9-8,15.3-8,24.5s3.1,17.6,8,24.3 C37.9,185.9,80.2,209,128,209s90.1-23.1,116.7-58.7c4.9-6.9,8-15.3,8-24.5S249.6,108.5,244.7,101.5z M227.5,138.7 c-23.7,31.3-60.3,49.7-99.5,49.7c-39.4,0-75.8-18.4-99.5-49.7c-2.7-3.7-4.3-8.2-4.3-12.7c0-4.3,1.6-9,4.3-12.7 C52.2,82.1,88.6,63.7,128,63.7c39.2,0,75.8,18.4,99.5,49.7c1.8,2.5,4.3,7.2,4.3,12.7S229.4,136.1,227.5,138.7z M128,79.2 c-25.8,0-46.8,20.8-46.8,46.8s21.1,46.8,46.8,46.8s46.8-21.1,46.8-46.8S153.8,79.2,128,79.2z M144.6,119.9 c-5.7,0-10.4-4.7-10.4-10.4c0-5.7,4.7-10.4,10.4-10.4c5.7,0,10.4,4.7,10.4,10.4C155,115.2,150.3,119.9,144.6,119.9z"></path> </g></svg>
                                    Wards Dewarded: <strong>${player.wards_destroyed || 0}</strong>
                                </p>
                            </div>
                        </div> 
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <p class="card-text">
                                    ...
                                    Healing: <strong>${player.hero_healing || 0}</strong>
                                </p>
                            </div>
                            <div class="col-md-6">
                                <p class="card-text">
                                    ...
                                    Camps Stacked: <strong>${player.camps_stacked || 0}</strong>
                                </p>
                            </div>
                        </div> 
                        ${generateTopHeroesSection()}
                    </div>
                </div>
            </div>
        </div>
...
async function fetchGameData() {
    try {
        ...
        data.radiant.players.forEach(player => {
            document.getElementById('radiant-cards').innerHTML += createPlayerCard(player);
        });

        // Populate Dire player cards
        data.dire.players.forEach(player => {
            document.getElementById('dire-cards').innerHTML += createPlayerCard(player);
        });
